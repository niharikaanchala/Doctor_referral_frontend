...
const ReferralsPage = () => {
  ...
  const handlePatientNameClick = (referral) => {
    setSelectedPatientDetails(referral.patientDetails);
        ...
        <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-4">
              <button
                onClick={onCancel}
                className="px-6 py-3 bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium rounded-lg transition-colors duration-200"
              >
                Cancel
              </button>
              <button
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">State Medical License:</span>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">State Medical Council:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">OP Consultation Fee</p>
                    <p className="text-lg font-bold text-blue-600">${doctor.op_consultation_fee}</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">Surgical Referral Fee</p>
                    <p className="text-lg font-bold text-blue-600">${doctor.surgical_referral_fee}</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">Chronic Condition Fee</p>
                    <p className="text-lg font-bold text-blue-600">${doctor.chronic_fee}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Referral Statistics */}
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 mb-3">Referral Statistics</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">Patients Referred</p>
                    <p className="text-lg font-bold text-blue-600">{doctor.patientsReferred}</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">Commission Percentage</p>
                    <p className="text-lg font-bold text-blue-600">{doctor.commission_percentage}%</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-lg p-3 border">
                    <p className="text-sm text-gray-600">Last Referral</p>
                    <p className="text-lg font-bold text-blue-600">{doctor.lastReferral}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
          ...
          <div className="p-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {filteredDoctors.map((doctor) => (
                    <div key={doctor.id} className="bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                      <div className="p-4">
                        {/* Doctor Header */}
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-gray-900 truncate">{doctor.full_name}</h3>
                            <p className="text-blue-600 font-medium text-sm">{doctor.specialization}</p>
                            <p className="text-gray-500 text-sm truncate">{doctor.hospital}</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium text-green-600">${doctor.op_consultation_fee}</span>
                          </div>
                        </div>
            ...
            {activeTab === 'received' && (
              <div>
                {/* Received Referrals Header */}
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6">
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 mb-2">Received Referrals</h2>
                    <p className="text-gray-600">Manage referrals sent to your doctors</p>
                  </div>
                  <div className="flex items-center space-x-4">
                    <span className="text-sm text-gray-600">
                      Total: {receivedReferrals.length} referrals
                    </span>
                  </div>
                </div>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {receivedReferrals.map((referral) => (
                          <tr key={referral.id} className="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">{referral.assignedDoctor}</div>
                            </td>
