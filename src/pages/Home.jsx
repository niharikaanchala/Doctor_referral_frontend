...
import icon02 from "../assets/images/availability.jpeg";
...
const Home = () => {
  ...
  <div className="py-[30px] px-5">
    ...
    <div className="mt-[30px]">
      ...
      <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center ">
        Search from a wide network of trusted specialists and general
        physicians to find the right doctor for your health needs.
      </p>
      <Link
        to="/doctors"
  ...
  <div className="py-[30px] px-5">
    ...
    <div className="mt-[30px]">
      ...
      <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center ">
        View real-time schedules and availability so you can plan your
        appointments at the most convenient time for you.
      </p>
      <Link
        to="/doctors"
        className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none "
  ...
  <div className="py-[30px] px-5">
    ...
    <div className="mt-[30px]">
      ...
      <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center ">
        Secure your appointment instantly with just a few clicks and get
        timely reminders for a smooth healthcare experience.
      </p>
      <Link
        to="/doctors"
        className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none "
